...
public class QueueToFileException extends Exception {

	public QueueToFileException() {
		super();
	}
	
	public QueueToFileException(String msg) {
		super(msg);
	}
	
	public QueueToFileException(Exception e) {
		super(e);
	}

	public QueueToFileException(Throwable t) {
		super(t);
	}
}
