...
public class FileToQueueException extends Exception {

	public FileToQueueException() {
		super();
	}
	
	public FileToQueueException(String msg) {
		super(msg);
	}
	
	public FileToQueueException(Exception e) {
		super(e);
	}

	public FileToQueueException(Throwable t) {
		super(t);
	}
}
